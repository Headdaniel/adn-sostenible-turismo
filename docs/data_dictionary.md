...
| `pasajeros_mun` | Turística | Pasajeros aéreos movilizados (mes) | — | Aeronáutica Civil (datos.gov.co) | ✅ | 11.0% |
| `extranjeros_mun` | Turística | Visitantes extranjeros no residentes (mes) | — | Migración Colombia (datos.gov.co) | ✅ | 2.1% |
...
| `rnt_prestadores` | Turística | Prestadores turísticos registrados (año) | — | RNT — MinCIT (datos.gov.co) | ✅ | 18.5% |
| `rnt_camas` | Turística | Camas de alojamiento registradas (año) | — | RNT — MinCIT (datos.gov.co) | ✅ | 17.6% |
| `rnt_habitaciones` | Turística | Habitaciones de alojamiento registradas (año) | — | RNT — MinCIT (datos.gov.co) | ✅ | 6.5% |
